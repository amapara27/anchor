...
export function SearchResultCard({
  ...
  return (
    <div className="card p-4">
      ...
      {isDownloading ? (
        <ResultDownloadBar download={download} totalBytes={profile.download_gb * GB} />
      ) : (
        <>
...
/** Compact download progress bar — mirrors `ModelCard`'s private DownloadBar. */
function ResultDownloadBar({ download, totalBytes }: { download: DownloadState; totalBytes: number }) {
